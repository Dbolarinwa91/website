...
resource "aws_instance" "app_server" {
  ...
  // No need for mainContentMargin variable since we're using complete sidebar hiding
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900 text-gray-100 overflow-x-hidden">
        ...
        {/* Sidebar toggle button is now positioned outside the sidebar when closed */}
        {!sidebarOpen && (
          <button
            className="fixed top-20 left-4 z-50 p-3 bg-blue-600 rounded-full shadow-lg transition-all duration-300"
        ...
        <div className="relative flex flex-col lg:flex-row">
          ...
          <aside
            className={`fixed top-0 left-0 h-screen z-40 transition-all duration-300 transform ${
          ...
          >
            <div className="flex flex-col h-full overflow-hidden">
              {/* Sidebar header with integrated toggle button */}
              <div className="px-4 py-6">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    className="p-2 bg-blue-600 rounded-full shadow-lg ml-2"
                    onClick={toggleSidebar}
                  >
                ...
                {/* Search bar - only visible when search is toggled and sidebar is open */}
                {sidebarOpen && searchVisible && (
              ...
              {/* Navigation links - only shown when sidebar is open */}
              ...
              <div className="px-4 py-4 border-t border-gray-800">
                <div className="flex items-center justify-between">
                  ...
                  {/* Search toggle button integrated in the sidebar */}
                  <button
                    className="p-2 bg-gray-700 rounded-lg ml-2"
          ...
          {/* Main content - centered with adjusted margin and padding to prevent header overlap */}
          <main className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'lg:ml-72' : ''}`}>
            <div className="max-w-4xl mx-auto px-6 sm:px-8 py-12 mt-16">
              ...
              <section data-section="ci-cd-pipelines" className="mb-16">
                ...
                <div className="prose prose-lg prose-invert max-w-none">
                  ...
                  {/* Remaining sections omitted for brevity but would follow the same pattern */}
                  {/* ... */}
